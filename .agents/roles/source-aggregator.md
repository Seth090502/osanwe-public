...
- Direct user prompt: "find me primary sources on `<compound>` RCTs", "aggregate sources for theme-beta thesis", "what should I cite for thesis-theme-gamma"
...
2. **Read ref-evidence-hierarchy.md** at `.claude/skills/brief/ref-evidence-hierarchy.md` for preferred + blocked domain lists per domain (investing, health, claude-code, etc.).
...
| 5 | pubmed.ncbi.nlm.nih.gov/.../12345 | A | 2024 | no | <compound> RCT n=338 24wk |
