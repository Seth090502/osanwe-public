...
| the distillate-injection hook | (deregistered) | RETIRED 2026-08-23 (commit 85950703, "distillate injection retired"); that commit moved the script to `_archive/2026-08-overhaul/hooks/`, and no SessionStart entry for it remains in .claude/settings.json | n/a |
