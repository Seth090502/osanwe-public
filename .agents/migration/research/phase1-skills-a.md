...
| decide | yes | 2130 (+1106) | 24946/377/6236 | 3 MANDATORY subagents (vault-researcher, decision-critic, thesis-critic-conditional) + literal hook-flag touch/rm (.claude/state/auto-commit-disabled) + hard-coded `node <HOME>\.vault-substrate\query-skill.mjs` (machine-portable, not user-portable) |
