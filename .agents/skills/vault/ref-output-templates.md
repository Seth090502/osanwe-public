...
```json
{
  ...
  "trend": "declining",
  "expected_archived": ["research", "review", "deep-v1", "invest-v1", "retro-v1", "spark-v1", "vault-v1"],
...
Per the AGENTS.md frontmatter schema. Audit Classifier 9 (template-drift) checks `_templates/daily.md` against this. Daily mode Phase D verifies today's daily note has all 9.
