...
Opt-in flags (all additive; default output unchanged):
  ...
  --include-breakdown   append per-domain score_breakdown (investing,
                        skill-infra, personal, meta) so the dragging
...
DOMAIN_RULES = [
    ...
    ("atlas/concepts/domain-a/", "personal"),
    ("atlas/sources/domain-a/", "personal"),
    ("<private-area>/", "personal"),
    ("<private-area>/", "personal"),
    ("<private-area>/", "personal"),
    ("efforts/domain-b/", "personal"),
    ("atlas/concepts/domain-b/", "personal"),
    ("atlas/sources/domain-b/", "personal"),
