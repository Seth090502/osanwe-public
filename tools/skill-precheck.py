...
(hook):
    ...
    ONE file. NOT registered in .claude/settings.json PostToolUse chain;
    batch/manual-invocation only (hook mode available for future wiring).
    Exits 0 on clean / non-md
...
Invocation patterns:
  ...
  Hook (--mode hook, stdin JSON): available; NOT currently registered in settings.json.
"""
import argparse
import difflib
import functools
