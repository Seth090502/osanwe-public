...
//
// READ-ONLY: verifiers never Write/Edit and never read the master-context doc.
...
L2 FALSIFIABILITY skeptic: the pattern statement must be testable -- it must imply an observable that could come out the other way ("weekly review cadence predicts decision follow-through" is testable; "investing is like meditation" is hand-waving). Metaphorical hand-waving -> lens FAILS -> REFUTED.
...
HARD RULES: never Write or Edit; never read <private-file>*.local.md or any master-context *.local.md file; ASCII-only; list every file you opened in checked_items.`
