...
| `### Active Blockers` | /retro + /invest | 7d | <=3 entries; trigger + owner + age; auto-prune on resolution |
...
- /invest, /enrich, /ingest, /challenge, /create-skill: read hot.md as context only; never mutate
